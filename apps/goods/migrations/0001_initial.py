# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2019-09-22 04:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default='', help_text='类别码', max_length=30, verbose_name='类别码')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_url', models.CharField(blank=True, max_length=100, null=True, verbose_name='图片url')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
